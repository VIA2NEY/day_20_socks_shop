import 'package:day_20_socks_shop/page/socks_page.dart';
                    ...
                    children: <Widget>[
                      Expanded(
                        ...
                        child: FadeAnimation(
                          1.2, 
                          Text(
                            'Meilleur Collection De Chaussettes \nEn Ligne !!', 
                            style: TextStyle(
                              fontSize: 20,
              ...
              child: Column(
                ...
                children: <Widget>[
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: <Widget>[
                      FadeAnimation(1.2, Text('Choisissez \nune categorie', style: TextStyle(
                        fontWeight: FontWeight.bold,
                        fontSize: 20,
                        color: Color.fromRGBO(97, 90, 90, 1)
                      )),),
                            ...
                            FadeAnimation(
                              ...
                              ElevatedButton(
                                style: ElevatedButton.styleFrom(
                                  ...
                                  backgroundColor:const Color.fromRGBO(251, 53, 105, 0.1),
                                ),
                                onPressed: (){}, 
                                child: const Text(
                                  'Adulte', 
                            ...
                            FadeAnimation(
                              ...
                              ElevatedButton(
                                style: ElevatedButton.styleFrom(
                                  ...
                                  shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(5)),
                                  padding: const EdgeInsets.all(10),
                                  backgroundColor:const Color.fromRGBO(97, 90, 90, 0.1),
                                ),
                                onPressed: (){}, 
                                child: const Text(
                                  'Enfant', 
